...
def index():
    ...
    cursor.execute('SELECT time_played, song_table.song_name, block_number FROM play_history_table INNER JOIN song_table ON song_table.song_name=play_history_table.song_name')
